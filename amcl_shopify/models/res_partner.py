...
class ResPartner(models.Model):
    ...
    shopify_last_order_id = fields.Char(string="Last Order Id", readonly="1")
    shopify_last_order_name = fields.Char(string="Last Order Name", readonly="1")
    ...
    multipass_identifier = fields.Char(string="Multi Pass Identifier", readonly="1")
    ...
    shopify_total_spent = fields.Monetary(string="Total Spent", readonly="1")
